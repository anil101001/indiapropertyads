...
import { Mail, Lock, Eye, EyeOff, Building2, ArrowRight, AlertCircle, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-primary-50 flex items-center justify-center px-4 py-8">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          {/* Google Sign-In */}
          <a
            href={`${import.meta.env.VITE_API_URL || 'http://localhost:5000/api/v1'}/auth/google?origin=${encodeURIComponent(window.location.origin)}`}
            className="flex items-center justify-center gap-3 w-full px-4 py-3 border-2 border-gray-200 rounded-lg hover:bg-gray-50 hover:border-gray-300 transition"
          >
